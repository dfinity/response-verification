...
describe('Assets', () => {
  ...
  [
    ...
    {
      url: '/assets/index-Lsq-0Bcw.js',
      asset: 'assets/index-Lsq-0Bcw.js.gz',
      encoding: 'identity, gzip',
      contentType: 'text/javascript',
      cacheControl: 'public, max-age=31536000, immutable',
    },
    // css file
    {
      url: '/assets/index-kNDHXHrP.css',
      asset: 'assets/index-kNDHXHrP.css',
      encoding: 'identity',
    ...
    {
      url: '/assets/index-kNDHXHrP.css',
      asset: 'assets/index-kNDHXHrP.css.br',
      encoding: 'identity, gzip, br',
      contentType: 'text/css',
      cacheControl: 'public, max-age=31536000, immutable',
    },
    {
      url: '/assets/index-kNDHXHrP.css',
      asset: 'assets/index-kNDHXHrP.css.gz',
      encoding: 'identity, gzip',
      contentType: 'text/css',
      cacheControl: 'public, max-age=31536000, immutable',
    },
