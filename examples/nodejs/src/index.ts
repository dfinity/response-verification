...
const request: Request = {
  url: "/",
  method: "GET",
  headers: [["Host", "qoctq-giaaa-aaaaa-aaaea-cai.ic0.app"]],
};
...
const current_time_ns = BigInt(1674558356377744128);
const max_cert_time_offset_ns = BigInt(300_000_000_000_000_000);
